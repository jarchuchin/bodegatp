...
Partial Class controles_DisplayAnunciosPromotions
    ...
    Sub colocardatos1()
        ...
        DataList1.DataSource = mya.GetDR(1, tienda.PaginaAnuncio.Promociones, 4)
        DataList1.DataBind()

    End Sub
    Sub colocardatos2()
        Dim mya As New tienda.AnuncioIdioma
        DataList2.DataSource = mya.GetDS(1, tienda.PaginaAnuncio.Promociones, 1)
        DataList2.DataBind()
    ...
    Sub colocardatos3()
        Dim mya As New tienda.AnuncioIdioma
        DataList3.DataSource = mya.GetDR(1, tienda.PaginaAnuncio.Promociones, 2)
        DataList3.DataBind()

Imports System.Data
Partial Class controles_DisplayProductosTags
    ...
    Sub colocardatos()
        ...
        If HttpContext.Current.Items("idCategoria") <> "" Then
            lblcategoria.Text = HttpContext.Current.Items("idCategoria")
            ...
            lbltags.Text = mycatego.tags
            lbltagstitle.Text = mycatego.metaKeywords

            'lnkCategoActual.Text = mycatego.nombre & " promocionales"
            'lnkCategoActual.NavigateUrl = "~/categorias/show/" & mycatego.idCategoria & "/" & getTags(mycatego.tags)

            lblNombreCatego.Text = mycatego.nombre.ToUpper & " PROMOCIONALES"
    ...
    Function llenargridLimites() As Integer
        ...
        If lbltags.Text <> "" Then
            ...
            Dim ds As DataSet = myp.GetDSTags(CInt(Session("ididioma")), lbltags.Text, rblOrden1x.SelectedValue, clavedesde, clavehasta, getListaColores, getListaMateriales, "")
            ...
            GridView1.DataSource = tablePaginas
            GridView1.DataBind()
    ...
    Protected Sub drpPrecios_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles drpPrecios.SelectedIndexChanged
        If drpPrecios.SelectedValue <> "" Then
            carpetafiles = System.Configuration.ConfigurationManager.AppSettings("carpetafiles") & "productos/images/ch/"
            categoria = CInt(HttpContext.Current.Items("idCategoria"))
            llenargridLimites()
    ...
    Protected Sub btnPaginas04_Click(sender As Object, e As EventArgs) Handles btnPaginas04.Click
        carpetafiles = System.Configuration.ConfigurationManager.AppSettings("carpetafiles") & "productos/images/ch/"
        categoria = CInt(HttpContext.Current.Items("idCategoria"))
        lblinicio.Text = lblFin.Text + 1
        lblFin.Text = CInt(lblFin.Text) + CInt(lblSize.Text)
        llenargridLimites()
    End Sub

    Dim varLocalPresentarPuntos As String = "False"
    ...
    Public Function presentarBoton(numeroPagina As Integer) As String
        ...
        Else
            Return "False"
            varLocalPresentarPuntos = "True"
        End If
    End Function

    Public Function presentarPuntos() As String
        Return varLocalPresentarPuntos
    End Function

<%@ Control Language="VB" AutoEventWireup="false" CodeFile="DisplayProductosSearch.ascx.vb" Inherits="controles_DisplayProductosSearch" %>
...
<div class="col-md-2  hidden-sm hidden-xs menu sidebarmenu" id="menulateralizq" >
    ...
    <div class="menuFiltrar">      
       ...
       <%-- <asp:RadioButton ID="rblOrden1" Checked="true" runat="server" Text="Orden Alfabético" value="Nombre asc" />
        ...
        <h4>PRECIO</h4>
        <asp:DropDownList ID="drpPrecios" runat="server" CssClass="form-control form-inline"  >
...
<asp:Label ID="lblSize" runat="server" Visible="False">25</asp:Label>

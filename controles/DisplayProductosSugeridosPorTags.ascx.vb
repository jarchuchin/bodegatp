...
Partial Class controles_DisplayProductosSugeridosPorTags
    ...
    Sub colocardatos()
        ...
        If HttpContext.Current.Items("tags") <> "" Then
            lblcategoria.Text = HttpContext.Current.Items("tags")
            tags = HttpContext.Current.Items("tags")
    ...
    Function llenargridLimites() As Integer
        ...
        Dim ds As DataSet = myp.GetDSTags(1, tags.Replace("-", ","), "Nombre", 0.1, 0, "", "", "")
    ...
    Public Function getTags(ByVal clavetags As String, ByVal clavenombre As String, ByVal claveProducto As String) As String
        claveProducto = claveProducto.Replace(" ", "-")

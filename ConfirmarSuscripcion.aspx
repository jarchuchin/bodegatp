<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage1Col.master" AutoEventWireup="false" CodeFile="ConfirmarSuscripcion.aspx.vb" Inherits="ConfirmarSuscripcion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPanelCentral" Runat="Server">
 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="2" >
        ...
        <tr>
          ...
          <p class="title1"><span class="title2"><img src="images/ico-ok.png" width="20" height="19" alt="ok" /></span> Suscripción agregada a la base de datos<br />
                  </p>
              <br />
              <br />
              <br />

...
Partial Class MasterPageBase2
    ...
    Public Property addBodyClass As String
        Set(value As String)
            If value <> "" Then
    ...
    Public Property fillScripts1 As Boolean
        Set(value As Boolean)
            If value = True Then
                litScript.Text = getScriptsMasterPage01()
            End If
        End Set
        Get
            Return False
    ...
    Public Property fillScripts2 As Boolean
        Set(value As Boolean)
            If value = True Then
                litScript.Text = getScriptsMasterPage02()
            End If
        End Set
        Get
            Return False
    ...
    Public Function getScriptsMasterPage01() As String
        ...
        Dim cadena9 As String = path & "App_Themes/Default/jquery.js"
        Dim cadena10 As String = path & "App_Themes/Default/bootstrap.js"

        Return "<script type=""text/javascript"" src=""" & cadena & """></script><script type=""text/javascript"" src=""" & cadena2 & """></script><script type=""text/javascript"" src=""" & cadena3 & """></script><script type=""text/javascript"" src=""" & cadena4 & """></script><script type=""text/javascript"" src=""" & cadena5 & """></script><script type=""text/javascript"" src=""" & cadena6 & """></script><script type=""text/javascript"" src=""" & cadena9 & """></script><script type=""text/javascript"" src=""" & cadena10 & """></script>"
    End Function

    Public Function getScriptsMasterPage02() As String
        Dim path As String = System.Configuration.ConfigurationManager.AppSettings("path")
        Dim cadena As String = path & "App_Themes/Default/jquery-1.4.2.min.js"
        Dim cadena2 As String = path & "App_Themes/Default/jquery.nivo.slider.pack.js"
        Dim cadena3 As String = path & "App_Themes/Default/SpryAssets/SpryMenuBar.js"

<%@ Page Title="Crear cuenta" Language="VB" MasterPageFile="~/MasterPage1Col.master" AutoEventWireup="false" CodeFile="AddUserDistribuidor.aspx.vb" Inherits="AddUserDistribuidor" meta:resourcekey="PageResource1" uiculture="auto" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPanelCentral" Runat="Server">
  

         <h2>Registro para distribuidores</h2>
        
	    Llena el siguiente formulario:
    <div style="height:10px;"></div>

    	<asp:validationsummary id="ValidationSummary2" runat="server" Width="100%"
					ValidationGroup="crear" CssClass="alert alert-danger"
...
<div class="form-horizontal">
    ...
    <div class="form-horizontal">
			 ...
			 <div class="form-group">
                 <label class="control-label col-sm-2" for="Nombre">Nombre del distribuidor:</label>
                 <div class="col-sm-8">
				<asp:TextBox id="txtNombreDistribuidor" runat="server" ValidationGroup="crear" cssclass="form-control" placeholder="Nombre"></asp:TextBox>
				<asp:requiredfieldvalidator id="RequiredFieldValidator1xx" runat="server"  ValidationGroup="crear" ControlToValidate="txtNombreDistribuidor" Display="None" ErrorMessage="Escribe El nombre de la empresa">*</asp:requiredfieldvalidator>
				<cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender4" runat="server" Enabled="True" TargetControlID="RequiredFieldValidator1xx"></cc1:ValidatorCalloutExtender>
	
                </div>
            </div>

        	 <div class="form-group">
                 <label class="control-label col-sm-2" for="Nombre">RFC:</label>
                 <div class="col-sm-8">
				<asp:TextBox id="txtRFC" runat="server" ValidationGroup="crear" cssclass="form-control" placeholder="RFC"></asp:TextBox>
				<asp:requiredfieldvalidator id="RequiredFidddeldValidator1" runat="server"  ValidationGroup="crear" ControlToValidate="txtRFC" Display="None" ErrorMessage="Escribe El RFC de la empresa">*</asp:requiredfieldvalidator>
				<cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender5" runat="server" Enabled="True" TargetControlID="RequiredFidddeldValidator1"></cc1:ValidatorCalloutExtender>
         ...
         <div class="form-group">
                 <label class="control-label col-sm-2" for="Nombre">Dirección completa:</label>
                 <div class="col-sm-8">
				<asp:TextBox id="txtDireccion" runat="server" ValidationGroup="crear" cssclass="form-control"  TextMode="MultiLine" Height="90px"></asp:TextBox>
			 ...
			 <div class="form-group">
                 <label class="control-label col-sm-2" for="Nombre">Giro comercial:</label>
                 <div class="col-sm-8">
				 <asp:DropDownList ID="drpgiro" runat="server"  
        	 ...
        	 <div class="form-group">
                 ...
                 <div class="col-sm-8">
				<asp:TextBox id="txtComentarios" runat="server" ValidationGroup="crear" cssclass="form-control"  TextMode="MultiLine" Height="90px"></asp:TextBox>
    ...
    <div class="col-sm-12 text-center">
                 ...
                 <asp:Button ID="btnRegistro" runat="server" Text="Registrarme como distribuidor" ValidationGroup="crear"  CssClass="btn btn-warning"  />
       
         <asp:Button ID="btnPrivacidad" runat="server" Text="Regresar"  CausesValidation="false"  CssClass="btn btn-default"  />
